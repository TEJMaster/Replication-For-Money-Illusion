...
In the creation of this project, OpenAI's ChatGPT was used to enhance the paragraphs, as well as assist in generating the plots. You can check the `inputs/misc/chat_with_chatGPT.txt` for a complete conversation of my usage of ChatGPT in this project.
